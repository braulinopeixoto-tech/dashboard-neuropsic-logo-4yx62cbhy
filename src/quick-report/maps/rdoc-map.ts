...
const RULES: Rule[] = [
  {
    ...
    terms: ['ansiedade', 'medo', 'evitacao', 'evitação', 'ameaca', 'ameaça', 'trauma', 'irritabilidade'],
  },
  {
    domain: 'Positive Valence Systems',
    construct: 'motivacao e recompensa',
    terms: ['motivacao', 'motivação', 'recompensa', 'prazer', 'apatia', 'anedonia', 'baixo engajamento'],
  },
  {
    domain: 'Cognitive Systems',
    construct: 'atencao, memoria e controle executivo',
    terms: ['atencao', 'atenção', 'memoria', 'memória', 'planejamento', 'inibição', 'controle inibitorio', 'funcoes executivas'],
  },
  {
    domain: 'Social Processes',
    construct: 'comunicacao e reciprocidade social',
    terms: ['social', 'reciprocidade', 'comunicacao', 'comunicação', 'interacao', 'interação', 'isolamento'],
  },
  {
    domain: 'Arousal / Regulatory Systems',
    construct: 'sono, vigilia e regulacao autonoma',
    terms: ['sono', 'insônia', 'insonia', 'vigilia', 'vigília', 'arousal', 'fadiga', 'sonolencia', 'sonolência'],
  },
  {
    domain: 'Sensorimotor Systems',
    construct: 'processamento sensoriomotor',
    terms: ['sensorial', 'sensoriomotor', 'motor', 'coordenação', 'coordenacao', 'hipersensibilidade'],
  },
]
